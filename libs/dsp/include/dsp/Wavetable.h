...
// Lifecycle
WavetableBank *createWavetableBank(uint8_t frameCount,
                                   const char (&name)[MAX_BANK_NAME_LEN]);
...
// NOTE: Bank registry (these may belong somewhere else--like WavetableBanks.h
